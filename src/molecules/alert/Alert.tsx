...
/** choose from these types of alerts */
...
export interface AlertProps extends React.HTMLAttributes<HTMLDivElement> {
    ...
    /**
     * If defined, shows icon at right which can be used to close alert
     */
    onClose?: () => void;
}
...
const Alert = React.forwardRef<HTMLDivElement, AlertProps>(function Alert(props, ref) {
    const {className, children, type = 'primary', onClose, style, ...other} = props;
    const {
        component: {alert},
    ...
    return (
        <div style={style} className={cls} role="alert" ref={ref} {...other}>
            {onClose && (
                <button
                    onClick={onClose}
